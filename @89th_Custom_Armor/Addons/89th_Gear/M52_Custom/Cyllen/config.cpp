class cfgPatches
{
	class 89th_M52A_Cyllen
	{
		...
		weapons[]=
		{
			"89th_M52A_Cyllen_ARD",
			"89th_M52A_Cyllen_DES",
			"89th_M52A_Cyllen_SNW",
			"89th_M52A_Cyllen_URB",
			"89th_M52A_Cyllen_WDL"
		};
	};
};
class cfgWeapons
{
	...
	class ItemInfo;
	class VestItem;
	class 89th_M52A_Cyllen_WDL: VES_M52D_Rifleman
	{
		dlc="FZ";
		author="Vice";
		displayName="[89th] M52A (Cyllen) (WDL)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\WDL\89th_SoftVest_WDL.paa",
			"89th_Gear\M52_Custom\Cyllen\89th_M52A_Cyllen_WDL.paa",
	...
	class 89th_M52A_Cyllen_DES: 89th_M52A_Cyllen_WDL
	{
		dlc="FZ";
		author="Vice";
		displayName="[89th] M52 (Cyllen) (DES)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\DES\89th_SoftVest_DES.paa",
			"89th_Gear\M52_Custom\Cyllen\89th_M52A_Cyllen_DES.paa",
			"89th_Gear\M52_Basic\DES\89th_M52_Underlay_DES.paa",
			"optre_unsc_units\army\data\ghillie_woodland_co.paa",
			"89th_Gear\M52_Basic\DES\89th_M52D_DES.paa"
		};	
	};
	class 89th_M52A_Cyllen_URB: 89th_M52A_Cyllen_WDL
	{
		dlc="FZ";
		author="Vice";
		displayName="[89th] M52 (Cyllen) (URB)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\URB\89th_SoftVest_URB.paa",
			"89th_Gear\M52_Custom\Cyllen\89th_M52A_Cyllen_URB.paa",
			"89th_Gear\M52_Basic\URB\89th_M52_Underlay_URB.paa",
			"optre_unsc_units\army\data\ghillie_woodland_co.paa",
			"89th_Gear\M52_Basic\URB\89th_M52D_URB.paa"
		};	
	};
	class 89th_M52A_Cyllen_SNW: 89th_M52A_Cyllen_WDL
	{
		dlc="FZ";
		author="Vice";
		displayName="[89th] M52 (Cyllen)) (SNW)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\SNW\89th_SoftVest_SNW.paa",
			"89th_Gear\M52_Custom\Cyllen\89th_M52A_Cyllen_SNW.paa",
			"89th_Gear\M52_Basic\SNW\89th_M52_Underlay_SNW.paa",
			"optre_unsc_units\army\data\ghillie_woodland_co.paa",
			"89th_Gear\M52_Basic\SNW\89th_M52D_SNW.paa"
		};	
	};
	class 89th_M52A_Cyllen_ARD: 89th_M52A_Cyllen_WDL
	{
		dlc="FZ";
		author="Vice";
		displayName="[89th] M52 (Cyllen) (ARD)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\ARD\89th_SoftVest_ARD.paa",
			"89th_Gear\M52_Custom\Cyllen\89th_M52A_Cyllen_ARD.paa",
...
class XtdGearModels
{
	class CfgWeapons
	{
		class 89th_Cyllen_M52A
		{
			label="[89th] Cyllen M52A";
			author="89th Mod Team";
			options[]=
			{
				"camo"
...
class XtdGearInfos
{
	class CfgWeapons
	{
		class 89th_M52A_Cyllen_ARD
		{
			model="89th_Cyllen_M52A";
			camo="ARD";
		};
		class 89th_M52A_Cyllen_DES
		{
			model="89th_Cyllen_M52A";
			camo="DES";
		};
		class 89th_M52A_Cyllen_SNW
		{
			model="89th_Cyllen_M52A";
			camo="SNW";
		};
		class 89th_M52A_Cyllen_URB
		{
			model="89th_Cyllen_M52A";
			camo="URB";
		};
		class 89th_M52A_Cyllen_WDL
		{
			model="89th_Cyllen_M52A";
			camo="WDL";
		};
