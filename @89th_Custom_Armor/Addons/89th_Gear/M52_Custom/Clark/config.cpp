...
class cfgWeapons
{
	...
	class ItemInfo;
	class VestItem;
	class 89th_M52A_Clark_ARD: 89th_M52A_Rifleman
	{
		dlc="89thJTF";
		author="Clark, Soup, Vespade";
	...
	class 89th_M52A_Clark_DES: 89th_M52A_Clark_ARD
	{
		dlc="89thJTF";
		author="Clark, Soup, Vespade";
...
class XtdGearModels
{
	class CfgWeapons
	{
		class 89th_Clark_M52A
		{
			label="[89th] Clark M52A";
			author="89th Mod Team";
			options[]=
			{
				"camo"
...
class XtdGearInfos
{
	class CfgWeapons
	{
		class 89th_M52A_Clark_ARD
		{
			model="89th_Clark_M52A";
			camo="ARD";
		};
		class 89th_M52A_Clark_DES
		{
			model="89th_Clark_M52A";
			camo="DES";
		};
		class 89th_M52A_Clark_SNW
		{
			model="89th_Clark_M52A";
			camo="SNW";
		};
		class 89th_M52A_Clark_URB
		{
			model="89th_Clark_M52A";
			camo="URB";
		};
		class 89th_M52A_Clark_WDL
		{
			model="89th_Clark_M52A";
			camo="WDL";
		};
