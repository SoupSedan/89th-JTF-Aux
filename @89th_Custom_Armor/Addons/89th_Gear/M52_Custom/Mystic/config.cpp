class cfgPatches
{
	class 89th_M52A_Custom
	{
		...
		weapons[]=
		{
			"89th_M52A_Mystic_ARD",
			"89th_M52A_Mystic_DES",
			"89th_M52A_Mystic_SNW",
			"89th_M52A_Mystic_URB",
			"89th_M52A_Mystic_WDL"
		};
	};
};
class cfgWeapons
{
	...
	class ItemInfo;
	class VestItem;
	class 89th_M52A_Mystic_ARD: 89th_M52A_Rifleman
	{
		dlc="89thJTF";
		author="Soup, Vespade";
		displayName="[89th] M52A (Mystic)(ARD)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\ARD\89th_SoftVest_ARD.paa",
			"89th_Gear\M52_Custom\Mystic\89th_M52A_Mystic_ARD.paa",
	...
	class 89th_M52A_Mystic_DES: 89th_M52A_Mystic_ARD
	{
		dlc="89thJTF";
		author="Mystic, Vespade";
		displayName="[89th] M52A (Mystic)(DES)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\DES\89th_SoftVest_DES.paa",
			"89th_Gear\M52_Custom\Mystic\89th_M52A_Mystic_DES.paa",
			"89th_Gear\M52_Basic\DES\89th_M52_Underlay_DES.paa",
			"optre_unsc_units\army\data\ghillie_woodland_co.paa",
			"89th_Gear\M52_Basic\DES\89th_M52D_DES.paa"
		};
	};
	class 89th_M52A_Mystic_SNW: 89th_M52A_Mystic_ARD
	{
		dlc="89thJTF";
		author="Mystic, Vespade";
		displayName="[89th] M52A (Mystic)(SNW)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\SNW\89th_SoftVest_SNW.paa",
			"89th_Gear\M52_Custom\Mystic\89th_M52A_Mystic_SNW.paa",
			"89th_Gear\M52_Basic\SNW\89th_M52_Underlay_SNW.paa",
			"optre_unsc_units\army\data\ghillie_woodland_co.paa",
			"89th_Gear\M52_Basic\SNW\89th_M52D_SNW.paa"
		};
	};
	class 89th_M52A_Mystic_URB: 89th_M52A_Mystic_ARD
	{
		dlc="89thJTF";
		author="Mystic, Vespade";
		displayName="[89th] M52A (Mystic)(URB)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\URB\89th_SoftVest_URB.paa",
			"89th_Gear\M52_Custom\Mystic\89th_M52A_Mystic_URB.paa",
			"89th_Gear\M52_Basic\URB\89th_M52_Underlay_URB.paa",
			"optre_unsc_units\army\data\ghillie_woodland_co.paa",
			"89th_Gear\M52_Basic\URB\89th_M52D_URB.paa"
		};
	};
	class 89th_M52A_Mystic_WDL: 89th_M52A_Mystic_ARD
	{
		dlc="89thJTF";
		author="Mystic, Vespade";
		displayName="[89th] M52A (Mystic)(WDL)";
		hiddenSelectionsTextures[]=
		{	
			"89th_Gear\M52_Basic\WDL\89th_SoftVest_WDL.paa",
			"89th_Gear\M52_Custom\Mystic\89th_M52A_Mystic_WDL.paa",
...
class XtdGearModels
{
	class CfgWeapons
	{
		class 89th_Mystic_M52A
		{
			label="[89th] Mystic M52A";
			author="89th Mod Team";
			options[]=
			{
				"camo"
...
class XtdGearInfos
{
	class CfgWeapons
	{
		class 89th_M52A_Mystic_ARD
		{
			model="89th_Mystic_M52A";
			camo="ARD";
		};
		class 89th_M52A_Mystic_DES
		{
			model="89th_Mystic_M52A";
			camo="DES";
		};
		class 89th_M52A_Mystic_SNW
		{
			model="89th_Mystic_M52A";
			camo="SNW";
		};
		class 89th_M52A_Mystic_URB
		{
			model="89th_Mystic_M52A";
			camo="URB";
		};
		class 89th_M52A_Mystic_WDL
		{
			model="89th_Mystic_M52A";
			camo="WDL";
		};
