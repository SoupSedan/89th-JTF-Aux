class cfgPatches
{
	class 89th_M52A_Custom
	{
		...
		weapons[]=
		{
			"89th_M52A_Syndex_ARD",
			"89th_M52A_Syndex_DES",
			"89th_M52A_Syndex_SNW",
			"89th_M52A_Syndex_URB",
			"89th_M52A_Syndex_WDL"
		};
	};
};
class cfgWeapons
{
	...
	class ItemInfo;
	class VestItem;
	class 89th_M52A_Syndex_ARD: 89th_M52A_Rifleman
	{
		dlc="89thJTF";
		author="Syndex, Vespade";
		displayName="[89th] M52A (Syndex)(ARD)";
	...
	class 89th_M52A_Syndex_DES: 89th_M52A_Syndex_ARD
	{
		dlc="89thJTF";
		author="Syndex, Vespade";
		displayName="[89th] M52A (Syndex)(DES)";
		hiddenSelectionsTextures[]=
		{	
	...
	class 89th_M52A_Syndex_SNW: 89th_M52A_Syndex_ARD
	{
		dlc="89thJTF";
		author="Syndex, Vespade";
		displayName="[89th] M52A (Syndex)(SNW)";
		hiddenSelectionsTextures[]=
		{	
	...
	class 89th_M52A_Syndex_URB: 89th_M52A_Syndex_ARD
	{
		dlc="89thJTF";
		author="Syndex, Vespade";
		displayName="[89th] M52A (Syndex)(URB)";
		hiddenSelectionsTextures[]=
		{	
	...
	class 89th_M52A_Syndex_WDL: 89th_M52A_Syndex_ARD
	{
		dlc="89thJTF";
		author="Syndex, Vespade";
		displayName="[89th] M52A (Syndex)(WDL)";
		hiddenSelectionsTextures[]=
		{	
...
class XtdGearModels
{
	class CfgWeapons
	{
		class 89th_Syndex_M52A
		{
			label="[89th] Syndex M52A";
			author="89th Mod Team";
			options[]=
			{
				"camo"
...
class XtdGearInfos
{
	class CfgWeapons
	{
		class 89th_M52A_Syndex_ARD
		{
			model="89th_Syndex_M52A";
			camo="ARD";
		};
		class 89th_M52A_Syndex_DES
		{
			model="89th_Syndex_M52A";
			camo="DES";
		};
		class 89th_M52A_Syndex_SNW
		{
			model="89th_Syndex_M52A";
			camo="SNW";
		};
		class 89th_M52A_Syndex_URB
		{
			model="89th_Syndex_M52A";
			camo="URB";
		};
		class 89th_M52A_Syndex_WDL
		{
			model="89th_Syndex_M52A";
			camo="WDL";
		};
